           ...
           <div class="grid md:grid-cols-2 gap-12 items-center">
               <div class="text-white ml-4">
                   ...
                   <div class="flex space-x-4">
                       <button
                           class="bg-white hover:bg-cyan-500 hover:text-white text-black font-bold py-3 px-8 rounded-full transition duration-300 transform hover:scale-105 group"
                           onclick="event.preventDefault(); document.getElementById('download').scrollIntoView({ behavior: 'smooth' });">
                           <img src="{{ asset('storage/download.png') }}" alt="download"
                               class="h-6 inline transition-all duration-300 group-hover:brightness-0 group-hover:invert"
                               style="margin-right: 8px; margin-bottom: 5px;">
                           <span style="font-family: 'Arial', sans-serif;">DOWNLOAD APLIKASI</span>
                       </button>

                       <style>
                           /* Tambahkan ini ke CSS Anda jika ingin custom transition */
                           .group:hover img {
