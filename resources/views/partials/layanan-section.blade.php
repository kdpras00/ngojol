    <!-- Layanan Section -->
    <section class="py-12 bg-white border-t border-gray-200" id="layanan">
        <div class="max-w-7xl mx-auto px-6">
            <h2 class="text-4xl font-bold text-center text-gray-800" style="margin-top: 3rem; mb-3">Layanan Ngojol</h2>
            <p class="text-xl text-center text-gray-600 mb-12" style="margin-top: 1rem; font-family: 'Arial', sans-serif;">
                Kami siap mengantar apa saja kebutuhanmu.
            </p>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div class="flex flex-col items-center text-center mt-16 mb-16">
                    ...
                    <p class="text-gray-600 mb-12" style="font-family: 'Arial', sans-serif;">Layanan pengantaran
                        dalam
                ...
                <div class="flex flex-col items-center text-center mt-16 mb-16">
                    ...
                    <p class="text-gray-600 mb-12" style="font-family: 'Arial', sans-serif;">Layanan
                        pengantaran dengan
