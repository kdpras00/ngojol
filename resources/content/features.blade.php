    ...
    <section class="py-24 bg-cyan-500 border-t border-gray-200" id="fitur">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <p class="text-xl text-center text-white mb-12" style="font-family: 'Arial', sans-serif;">Kami Hadir
                Untuk
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600" style="font-family: 'Arial', sans-serif;">Layanan pengiriman
                            express
                ...
                <div
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600" style="font-family: 'Arial', sans-serif;">Kirim paket Anda
                            dengan aman
                ...
                <div
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600" style="font-family: 'Arial', sans-serif;">Pesan makanan favorit
                            Anda
